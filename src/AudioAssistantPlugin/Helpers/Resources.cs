namespace Loupedeck.AudioAssistantPlugin {
  ...
  internal static class Resources {
    ...
    // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.AudioAssistantPlugin.Resources`.
    // Returns the full names of the resource files, for example, `Loupedeck.AudioAssistantPlugin.Resources.Resource.txt`.
